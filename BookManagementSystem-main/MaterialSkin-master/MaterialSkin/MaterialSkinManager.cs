namespace MaterialSkin
{
    ...
    public class MaterialSkinManager
    {
        ...
        private void addFont(byte[] fontdata)
        {
            ...
            uint cFonts = 0;
            // GDI Font
            NativeTextRenderer.AddFontMemResourceEx(fontdata, dataLength, IntPtr.Zero, out cFonts);
        ...
        {
            GCHandle hObject = GCHandle.Alloc(Properties.Resources.SourceHanSansCN_Light, GCHandleType.Pinned);

            IntPtr intptr = hObject.AddrOfPinnedObject();

            PrivateFontCollection privateFontCollection = new PrivateFontCollection();

            privateFontCollection.AddMemoryFont(intptr, Properties.Resources.SourceHanSansCN_Light.Length);//从内存加载
        }
